...
const CasesTwo = () => {
  return (
    <div className="fixed h-screen w-full flex flex-col items-center justify-center bg-black text-white text-center px-4">
      {/* Text Section */}
      <div className="fixed frame27 top-[10%] sm:top-[15%] max-w-[1000px] text-left mx-4">
      ...
      <div className="fixed md:right-32 frame27 top-[45%] sm:top-[40%] max-w-[600px]  mx-4">
        <h1 className="text-md mb-4">
      ...
      <img
        ...
        className="frame27 fixed bottom-0 left-0 w-[400px] sm:w-[70vw] max-w-[800px]"
      />
      ...
      <div className="fixed frame29 top-28 left-4 lg:left-28 max-w-[600px] text-left mx-4">
        <h1 className="text-md mb-4">
        ...
        <img
          src={womamMan}
          alt="Relógio representando a passagem do tempo"
          className="frame29 fixed bottom-0 right-0 w-[400px] sm:w-[70vw] max-w-[1000px]"
        />
      </div>
      ...
      <div className="fixed frame31 top-14 sm:top-20 sm:right-36 text-left mx-4">
        ...
        <p className="text-white text-lg pt-20 sm:pt-28 flex flex-col sm:flex-row items-center">
          “Ele era ciumento. Tinha posse de mim”.
          <div className="flex mt-4 sm:mt-0">
            <button
              className="w-7 h-7 bg-transparent border-none cursor-pointer ml-10"
              onClick={() => alert("Button 1 clicked")}
            >
              <img src={replay} alt="Button 1" className="w-full h-full" />
            </button>
        ...
        <p className="text-white text-lg pt-16 flex flex-col sm:flex-row items-center">
        ...
        <img
          src={womanOnHand}
          alt="Relógio representando a passagem do tempo"
          className="frame31 fixed bottom-0 left-0 w-[70vw] sm:w-[50vw] max-w-[800px]"
        />
      </div>
      ...
      <div className="fixed frame34 top-14 sm:top-20 sm:left-36 text-left mx-4">
        ...
        <p className="frame35 text-white text-lg pt-20 sm:pt-28 flex flex-col sm:flex-row items-center">
      ...
      <div className="fixed frame37 top-14 max-w-[600px] sm:top-28 sm:right-10 text-left mx-4">
        ...
        <p className="text-white text-lg pt-20 sm:pt-28 flex flex-col items-start">
          “Teve uma vez que ele me perseguiu. Ele virou pra mim e falou: estou
          apenas te vigiando. Seguindo os teus passos.”
        </p>
        <div className="flex items-center mt-4">
          <button
            className="w-7 h-7 bg-transparent border-none cursor-pointer mr-2"
            onClick={() => alert("Button 1 clicked")}
          >
            <img src={replay} alt="Button 1" className="w-full h-full" />
          </button>
        ...
        <img
          src={girlsShadow}
          alt="Relógio representando a passagem do tempo"
          className="frame37 fixed bottom-0 left-0 w-[400px] sm:w-[70vw] max-w-[800px]"
        />
      </div>
    </div>
  );
