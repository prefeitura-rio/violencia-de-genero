...
import secretariaMulher from "../assets/secretaria_mulher.png";
import civitas from "../assets/civitas.png";
const Conclusion = () => {
  return (
    <>
      <div className="fixed top-10 sm:top-20 text-white left-0 sm:left-20 max-w-[600px] text-left mx-4 z-20">
        <h1 className="frame1-conclusao text-xl">
          Estatisticamente, um dos maiores problemas para que mulheres deixem
          esses parceiros e busquem ajuda é a dependência financeira. Por isso,
          a Prefeitura do Rio oferece auxílios financeiros e apoio às vítimas:
        </h1>
        <br></br>
        <span className="frame1b-conclusao text-xl">
          ...
          Auxílio de R$500 para mulheres em situação de vulnerabilidade
          socioeconômica atendidas pela Secretaria.
        </span>
      </div>
      <div className="fixed top-10 sm:top-20 text-white left-0 sm:left-20 max-w-[600px] text-left mx-4 z-20">
        ...
        <span className="frame2-conclusao text-xl">
          ...
          Um programa de auxílio passagem, no valor equivalente a 6 (seis)
          passagens de ônibus por dia, para mulheres em situação de violência
          doméstica e familiar. O objetivo é garantir o deslocamento e a
          continuidade de atendimento nos serviços da Rede Especializada de
      ...
      <div className="fixed top-10 sm:top-20 text-white left-0 sm:left-20 max-w-[600px] text-left mx-4 z-20">
        ...
        <span className="frame3-conclusao text-xl">
          ...
          O Cartão Mulher Carioca – Órfãos do Feminicídio é disponibilizado de
          forma emergencial para famílias de vítimas desse tipo de crime
          ocorridos no município. O valor mensal é de R$400 para cada um dos
          filhos, durante seis meses, podendo ser prorrogado por até mais seis
          meses.
        </span>
      </div>
        ...
        <div className="mb-6 fixed top-1/2 -translate-y-1/2 items-center flex flex-col max-w-[600px] text-left mx-4">
          <h1 className="text-xl mb-2">
            ...
            <span className="hidden 3xl:block">
              ...
              que esses esforços sejam continuamente{" "}
              <span className="text-[#EECBAD]">
                <b>fortalecidos e ampliados</b>
              </span>
        ...
        <div className="flex flex-col items-center max-w-[600px]">
          ...
          <div className="mt-10">
            <img
              ...
              className="h-7 lg:h-10 w-auto filter invert"
            />
          </div>
        </div>
      </div>
      <div className="frame6-2-conclusao fixed inset-0 flex flex-col items-center justify-center bg-black text-center text-white px-4">
        <div className="flex flex-col items-center max-w-[600px]">
          {/* Title */}
          <h1 className="text-2xl font-bold text-[#EECBAD] mb-6">Créditos</h1>
          ...
          <div className="text-center space-y-6">
            ...
            <div>
              ...
              <p>Joice Trindade</p>
              <p>Lidiane de Paula</p>
            </div>
            {/* CIVITAS */}
            <div>
              <h2 className="text-lg font-semibold">CIVITAS</h2>
              <p>Maria Eduarda Couto</p>
              <p>Davi Carreiro</p>
              <p>Manoela Bastos</p>
            </div>
            {/* Prefeito */}
          ...
          {/* Logos */}
          <div className="mt-10 flex flex-row space-x-4 lg:space-x-16">
            <img
              src={secretariaMulher}
              alt="Prefeitura do Rio Logo"
